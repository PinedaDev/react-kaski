...
import StoreAddCartBtn from './StoreAddCartBtn'
...
const StoreItem = (props) => {
    ...
    return (
        <div style={{ background: props.background }} className={"store_item all" + props.category}>
            <div className="store_item_top">
                <StoreBuyBtn
                    onHover={onBuyHover}
            ...
            <div className="store_item_details">
